...
export default async function CategoriesReportPage({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-base font-medium tracking-tight">Hours by category</h3>
        <p className="text-sm text-[var(--color-text-muted)]">
          Approved hours grouped by main category (Project, Admin, Office &amp; Sales) and by sub-category.
        </p>
      </div>
