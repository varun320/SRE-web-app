...
export function EntryTable({ timesheet, initialEntries, subCategories, projects, openingTil, openingVacation }: Props) {
  ...
  return (
    <div>
      ...
      <div className="mx-3 md:mx-4 mb-6 rounded-[var(--radius-lg)] bg-[var(--color-surface)] shadow-[var(--shadow-card)] border border-[var(--color-border-soft)] overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between px-3 md:px-4 py-3 border-t border-[var(--color-border-soft)] mt-2 gap-3 md:gap-4">
